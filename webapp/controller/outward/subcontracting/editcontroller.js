sap.ui.define([
    ...
    function (Controller, MessageBox, Device, SearchField, TypeString, ColumnListItem, Label, Filter, UIComponent, FilterOperator, JSONModel,library,Token,ODataModel,Column,MessageToast) {
        ...
        return Controller.extend("gatepassapp.controller.outward.subcontracting.editcontroller", {
                ...
                var that = this;
                    model0.read("/YY1_ZGE_OUTWARD_GATEPASS", {
                        ...
                        success: function (ODat, oRespons) {
                            ...
                            var dd = '' + value11.ChallanDate.getDate();
                            var mm = '' + (value11.ChallanDate.getMonth() + 1); //January is 0!
                            if (mm.length < 2) {
                                mm = '0' + mm;
                            }
                            if (dd.length < 2) {
                            ...
                            var yyyy = value11.ChallanDate.getFullYear();
                            let ChallanDate01 = yyyy + '-' + mm + '-' + dd;
                            ...
                            that.getView().byId("id_edit_challan_no_h").setValue(value11.ChallanNo)
                            that.getView().byId("id_edit_challan_date_h").setValue(ChallanDate01)
        ...
        OnEditFragOpen:function(oEvent){
            if (!this.OnEditFragOpen000) {
                this.OnEditFragOpen000 = sap.ui.xmlfragment(this.getView().getId("Edit_Frag_Id"), "gatepassapp.view.outward.subcontracting.fragment.changedeletedocument", this);
        ...
        OnGateEntryNoFragOpen:function(oEvent){
            if (!this.SoDocChange) {
                this.SoDocChange = sap.ui.xmlfragment(this.getView().getId("GateEntryDocNoId"), "gatepassapp.view.outward.subcontracting.fragment.gateentrydocno", this);                this.getView().addDependent(this.SoDocChange);
            }
            ...
            if(GateEntryNo.trim() === ""){
                ...
                sap.m.MessageToast.show("Please enter/select Gate Pass No...")
                    ...
                    let getArray = [
                        ...
                        "id_edit_net_wt_h",
                        "id_edit_gross_wt_h",
                        "id_edit_challan_no_h",
                        "id_edit_challan_date_h",
                        "id_edit_remark_h"
                    ];
                ...
                let ChallanNo = this.getView().byId("id_edit_challan_no_h").getValue()
                let ChallanDate0 = this.getView().byId("id_edit_challan_date_h").getValue()
                console.log("ChallanDate0:", ChallanDate0);
                if(ChallanDate0.trim() !== ""){
                    var ChallanDate = new Date(ChallanDate0);
                }else{
                    var ChallanDate = null;
                }
                ...
                if (ValidationArrayNonDatas.length === 0 || ValidationArrayNonDatas.length === "0" ){
                        ...
                        success: function(data) {
                            ...
                            that.getView().byId("id_edit_challan_no_h").setValue("")
                            that.getView().byId("id_edit_challan_date_h").setValue("")
    ...
    OnClose: function () {
        ...
        this.getView().byId("id_edit_challan_no_h").setValue("")
        this.getView().byId("id_edit_challan_date_h").setValue("")
