sap.ui.define([
    ...
    "gatepassapp/controller/outward/vendorreturn/editcontroller",
    "sap/ui/Device",
    'sap/m/SearchField',
    ...
    function (Controller, Device,SearchField,TypeString,ColumnListItem,Label,Filter,FilterOperator,MessageBox, MessageToast) {
        ...
        return Controller.extend("gatepassapp.controller.outward.vendorreturn.createvendorreturn", {
            onInit: function () {    
            ...
            onValueHelpRequested: function() {
                ...
                oModel1.read("/YY1_ZGE_INWARD_MD_ITEM", {
                    ...
                    success: function (oData) {
                        ...
                        that.loadFragment({
                            name: "gatepassapp.view.outward.vendorreturn.fragment.ValueHelpDialogFilterbar"
            ...
            OnSubmit: function (oEvent) {
                ...
                if(Tokensss.length > 0){
                    ...
                    var oFilter11 = new sap.ui.model.Filter("ScreenCode", sap.ui.model.FilterOperator.EQ, "GE10");
