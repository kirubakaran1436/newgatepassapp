sap.ui.define([
    "gatepassapp/controller/outward/stooutbound/editcontroller",
    ...
    function (Controller, MessageBox, Device, SearchField, TypeString, ColumnListItem, Label, Filter, UIComponent, FilterOperator, JSONModel,library,Token,ODataModel,Column,MessageToast) {
        ...
        return Controller.extend("gatepassapp.controller.outward.stooutbound.createstooutbound", {
            onInit: function () {    
            ...
            var GetValue = oItem ? oItem.getText() : "";
             ...
             this.getView().byId("id_sto_tar_wt_h").setValue(Gross_WT)
            ...
            onValueHelpRequested: function() {
                ...
                this.loadFragment({
                    name: "gatepassapp.view..outward.stooutbound.fragment.SalesValueHelpDialogFilterbar"
            ...
            OnSubmit: function (oEvent) {
                ...
                if(Tokensss.length > 0){
                    ...
                    var oFilter11 = new sap.ui.model.Filter("ScreenCode", sap.ui.model.FilterOperator.EQ, "GE9");
                    var CountoModel = this.getView().getModel("YY1_ZGE_OUTWARD_GATEPASS_CDS");
            ...
            if (ValidationArrayNonDatas.length === 0 || ValidationArrayNonDatas.length === "0" ){
                ...
                for (let kk=0; kk < Delivery_Document_Array.length; kk++){
                    ...
                    headerdata.push({
                        ...
                        Remarks:Remarks,
                        Status:"created",
                        DeliveryDocumentNo:Delivery_Document,
                        BillingDocumentNo:"",
                        SalesReturnNo:"",
                        ScreenCode:"GE9",
                        TareWeight:Tare_Wt,
                        ...
                        DelDocGrossWeight:"",
                        ChallanNo:"",
                        ChallanDate:this.CurrentDate01,
                    });
                ...
                for (var i = 0; i < Table_Length; i++) {
                    ...
                    if(Open_Quantity00 !== "0" || Open_Quantity00 !== 0 ){
                        ...
                        itemData.push({
                            ...
                            ApproveStatus:"",
                            BillingDocument:"",
                            DeliveryDocumentNo:Customer_Document_No,
                            SalesReturnNo:"",
                            ScreenCode:"GE9",
                            TareWeight:Tare_Wt,
                            NetWeight:Net_Wt,
