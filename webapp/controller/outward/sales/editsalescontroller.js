sap.ui.define([
    ...
    function (Controller, MessageBox, Device, SearchField, TypeString, ColumnListItem, Label, Filter, UIComponent, FilterOperator, JSONModel,library,Token,ODataModel,Column,MessageToast) {
        ...
        return Controller.extend("gatepassapp.controller.outward.sales.editsalescontroller", {
        ...
        // ===========================================================================
            ...
            onEditValueHelpRequested: function() {
                ...
                this.loadFragment({
                    name: "gatepassapp.view..outward.sales.fragment.EditSalesValueHelpDialogFilterbar"
        ...
        OnStoGateEntryNoFragOpen:function(oEvent){
            if (!this.SoDocChange) {
                this.SoDocChange = sap.ui.xmlfragment(this.getView().getId("STOGateEntryDocHead01_dialog"), "gatepassapp.view.outward.sales.fragment.stogateentrydocno", this);
