sap.ui.define([
    ...
    function (Controller, MessageBox, MessageToast, Fragment, Filter, FilterOperator, JSONModel, UI5Date) {
        ...
        return Controller.extend("gatepassapp.controller.rgp_nrgp.gateinoutrgpnrgp", {
            onInit: function () {
            ...
            OnRGPNRGPSuggest:function(oEvent){
                ...
                var filter1 = new sap.ui.model.Filter("Status", sap.ui.model.FilterOperator.EQ, "approved");
                ...
                model0.read("/YY1_ZRGP_NRGP_HEAD", {
                    ...
                    success: function (ODat, oRespons) {
                        ...
                        var GateStatus = value11.GateStatus;
                        ...
                        }else if(GateStatus === "gateout" && Status === "approved"){
            ...
            OnGateIn:function(){
                ...
                if (oBindingContext) {
                    ...
                    if (ItemNo !== "") {
                        var Delete_Status = "gatein";
                        
                    var itemData = {
                        GateStatus: Delete_Status
                    };
                ...
                success: function(data) {
                    ...
                    MessageBox.success("Gate Entry No " + GateEntryNo + " Gate In Successfully", {
                        title: " RGP NRGP ",
                        id: "messageBoxId1",
                        contentWidth: "100px",
                    });     
            ...
            OnGateOut:function(){
                ...
                error: function(error) {
                    console.error("Error updating header:", error);
                    MessageBox.success("Gate Entry No " + GateEntryNo + " Gate Out Successfully", {
                        title: " RGP NRGP ",
                        id: "messageBoxId1",
                        contentWidth: "100px",
                    });
