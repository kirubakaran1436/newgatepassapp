sap.ui.define([
    ...
    function (Controller, MessageBox, Device, SearchField, TypeString, ColumnListItem, Label, Filter, UIComponent, FilterOperator, JSONModel,library,Token,ODataModel,Column,MessageToast) {
        ...
        return Controller.extend("gatepassapp.controller.inward.subcontractinggoodsreceipt.editcontroller", {
        ...
        OnEditFragOpen:function(oEvent){
            if (!this.OnEditFragOpen001) {
                this.OnEditFragOpen001 = sap.ui.xmlfragment(this.getView().getId("Edit_Frag_Id"), "gatepassapp.view.inward.subcontractinggoodsreceipt.fragment.changedeletedocument", this);
        ...
        OnGateEntryNoFragOpen:function(oEvent){
            if (!this.SoDocChange) {
                this.SoDocChange = sap.ui.xmlfragment(this.getView().getId("GateEntryDocNoId"), "gatepassapp.view.inward.subcontractinggoodsreceipt.fragment.gateentrydocno", this);                this.getView().addDependent(this.SoDocChange);
            }
