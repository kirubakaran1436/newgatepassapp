sap.ui.define([
    "gatepassapp/controller/inward/salesreturn/editcontroller",
    ...
    function (Controller, MessageBox, Device, SearchField, TypeString, ColumnListItem, Label, Filter, UIComponent, FilterOperator, JSONModel,library,Token,ODataModel,Column,MessageToast) {
        ...
        return Controller.extend("gatepassapp.controller.inward.salesreturn.createsalesreturn", {
            ...
            onValueHelpRequested: function() {
                ...
                this.loadFragment({
                    name: "gatepassapp.view.inward.salesreturn.fragment.ValueHelpDialogFilterbar"
            ...
            OnSubmit: function (oEvent) {
                ...
                if(Tokensss.length > 0){
                    ...
                    var oFilter11 = new sap.ui.model.Filter("ScreenCode", sap.ui.model.FilterOperator.EQ, "GE4");
                    ...
                    sap.m.MessageToast.show("Please enter/select Customer Return");
                    sap.ui.core.BusyIndicator.hide();
                }
        ...
        OnFormatterCustomerCode : function(value1){
           ...
           if(value1 !== null){
            ...
            return new Promise(function(resolve, reject) {
                ...
                var oFilter = new sap.ui.model.Filter("CustomerReturn", sap.ui.model.FilterOperator.EQ, value1);           
