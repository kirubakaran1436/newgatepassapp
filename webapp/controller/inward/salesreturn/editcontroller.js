sap.ui.define([
    ...
    function (Controller, MessageBox, Device, SearchField, TypeString, ColumnListItem, Label, Filter, UIComponent, FilterOperator, JSONModel,library,Token,ODataModel,Column,MessageToast) {
        ...
        return Controller.extend("gatepassapp.controller.inward.salesreturn.editcontroller", {
        ...
        onedittokenupdate:function(oEvent){
            ...
            try{
                ...
                if(DelTokens.length > 0){
                    ...
                    var aFilters1 = new sap.ui.model.Filter("CustomerReturn", sap.ui.model.FilterOperator.EQ, "")
                } 
        ...
        // ===========================================================================
            ...
            onEditValueHelpRequested: function() {
                ...
                this.loadFragment({
                    name: "gatepassapp.view.inward.salesreturn.fragment.EditSalesValueHelpDialogFilterbar"
                    ...
                    oDialog.getTableAsync().then(function (oTable) {
                        ...
                        if (oTable.bindRows) {
                            ...
                            oTable.bindAggregation("rows", {
                                path: "YY1_ZGE_INWARD_SR_HEAD_CDS>/YY1_ZGE_OUTWARD_OD_HEAD",
                                events: {
                            ...
                            oColumnProductName = new sap.ui.table.Column({label: new sap.m.Label({text: "Customer"}), template: new sap.m.Text({wrapping: false, text: "{YY1_ZGE_INWARD_SR_HEAD_CDS>CustomerName}"})});
        ...
        OnStoChangeDocNoFragOpen:function(oEvent){
            if (!this.StoChangeDocNohead) {
                this.StoChangeDocNohead = sap.ui.xmlfragment(this.getView().getId("STODialogFrag"), "gatepassapp.view.inward.salesreturn.fragment.changedeletedocument", this);
        ...
        OnStoGateEntryNoFragOpen:function(oEvent){
            if (!this.SoDocChange) {
                this.SoDocChange = sap.ui.xmlfragment(this.getView().getId("STOGateEntryDocHead01_dialog"), "gatepassapp.view.inward.salesreturn.fragment.gateentrydocno", this);
        ...
        OnSTOGateEntryDocSelect : function (oEvent) {
            ...
            if (aContexts === undefined){
                ...
                var multiInput = this.getView().byId("id_edit_sto_purchase_document_h");
                    multiInput.removeAllTokens();
                this.InitialDelDocNo = []; // Customer Return No Based on create page gatepass no
